...
/***/ function(module, exports, __webpack_require__) {
	...
	//加载组件
	/**
	 * 在容器中，将reducers 和 Action 和 组件 自动连接起来
	 * 
	 * 在容器中做这样的关联一共有5中方式，可以在react-redux-book>11-counter-connect的例子中查看
	 * 
	 * state.counter:可以获取指定reducer的状态值。counter为reducer的名称
	 */
	exports.default = (0, _reactRedux.connect)(function (state) {
	  return { counter: state.counter };
	}, //state.counter：通过state对象加reducer名称，获取指定reducer返回的值
